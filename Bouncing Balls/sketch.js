...
function draw() {
  ...
  ball2.bounce(leftEdge);
  ball2.bounce(rightEdge);
  ball2.bounce(bottomEdge);
  ball2.bounce(topEdge);
  ...
  if (mouseIsPressed) {
    ...
    //ball2
    ball2.velocity.x = 1; // Left or Right
    ball2.velocity.y = 1; // Top to Bottom
    ball2.setSpeed(8);
  }
